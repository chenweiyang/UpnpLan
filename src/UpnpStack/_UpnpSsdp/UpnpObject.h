...
UPNP_API CtRet UpnpObject_Construct(UpnpObject *thiz);
UPNP_API CtRet UpnpObject_Dispose(UpnpObject *thiz);
UPNP_API void UpnpObject_Delete(UpnpObject *thiz);
UPNP_API void UpnpObject_Copy(UpnpObject *dst, UpnpObject *src);

UPNP_API CtRet UpnpObject_SetNt(UpnpObject *thiz, const char *nt, bool strict_uuid);
